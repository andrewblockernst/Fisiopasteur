...
-- Version extendida 
CREATE OR REPLACE FUNCTION public.buscar_pacientes_smart(
  search_term text,
  max_rows integer,
...
-- Wrapper legacy sin parametros extra (compatibilidad)
CREATE OR REPLACE FUNCTION public.buscar_pacientes_smart(
  search_term text,
  max_rows integer
)
