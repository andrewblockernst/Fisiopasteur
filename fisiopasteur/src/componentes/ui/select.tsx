...
/**
 * Select — wrapper sobre Radix Select. Estilo consistente con Input.
 *
 * Uso:
 * ```tsx
...
>(({ className, children, size = "md", error, ...props }, ref) => {
  ...
  return (
    <SelectPrimitive.Trigger
      ...
      className={cn(
        "flex w-full items-center justify-between gap-2 rounded-md border border-input bg-background text-foreground " +
...
>(({ className, children, position = "popper", ...props }, ref) => (
  <SelectPrimitive.Portal>
    <SelectPrimitive.Content
      ...
      position={position}
      className={cn(
        "relative z-50 max-h-[--radix-select-content-available-height] min-w-[8rem] overflow-hidden rounded-md border border-border bg-popover text-popover-foreground shadow-lg " +
